    ...
    $(document).on('submit', '.form_deposit', function (e) {
        ...
        if (go == '0') {
            ...
            if ($('#deposit_tip').val() == 8) {
                ...
                $('#deposit').append('<input name="InvDesc" type="hidden" value="Пополнение счета">');
            ...
            if ($('#deposit_tip').val() == 9) {
                ...
                $('#deposit').append('<input name="ik_desc" type="hidden" value="Пополнение счета">');
    ...
    var methods = {
        init: function () {
            $.ajax({
                ...
                success: function (data) {
                    if(data['tpl3']==0){
                        $('#style_components').attr("href", "/assets/global/css/components-rounded.css");
                    }else{
                        $('#style_components').attr("href", "/assets/global/css/components.css");
                    }
                    if(data['tpl']==1){
                        $('link[href="/assets/admin/layout2/css/layout.css"]').attr('href',"/assets/admin/layout4/css/layout.css");
                        $('link[href="/assets/admin/layout2/css/themes/grey.css"]').attr('href',"/assets/admin/layout4/css/themes/light.css");
                        $(".page-sidebar-menu").removeClass("page-sidebar-menu-compact");
                    }else{
                        $('link[href="/assets/admin/layout4/css/layout.css"]').attr('href',"/assets/admin/layout2/css/layout.css");
                        $('link[href="/assets/admin/layout4/css/themes/light.css"]').attr('href',"/assets/admin/layout2/css/themes/grey.css");
                    ...
                    $('body>.preloader-bar').fadeIn("slow");
                    $('body>.page-container').fadeIn("slow");
                    $('body>.page-footer').fadeIn("slow");
                    $('body>.container>.page-container').fadeIn("slow");
                    $('body>.container>.page-footer').fadeIn("slow");
                    pre_load_off();
                }
            });
        }
